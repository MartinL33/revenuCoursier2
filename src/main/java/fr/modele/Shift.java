...
public abstract class Shift {
	...
	public String toString() {
		...
		res.append(dateFormatFacture.format(calendarDebut.getTime())+" ");
		res.append(formatDouble(this.getDuree())+"h ");
		res.append(formatDouble(this.getNbCommande())+": €");
		res.append(formatDouble(this.getRevenue())+" "); 
