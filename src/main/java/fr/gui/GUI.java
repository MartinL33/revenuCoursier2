...
import static fr.modele.Text.textDossierChoisi;
import static fr.modele.Value.tabRegroupage;
...
public class GUI extends JFrame{
	...
	private final JComboBox<?> comboCouleurCarte = new JComboBox<Object>(fr.map.EcrireMap.couleurMap);
	...
	class BoutonLancerListener implements ActionListener{
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			Value.couleurSelected=fr.map.EcrireMap.couleurMap[comboCouleurCarte.getSelectedIndex()];
