...
import static Map.ValueMap.DISTANCE_LONGUE;
import static Map.ValueMap.DUREE_MIN_FIN;
import static Map.ValueMap.DUREE_MIN_SAUVEGARDE_PAS;
import static Map.ValueMap.IND_ARRET_INCONNU;
import static Map.ValueMap.IND_DEFAUT;
import static Map.ValueMap.IND_DEPLACEMENT_INCONNU;
import static Map.ValueMap.IND_DEPLACEMENT_LIGNE_DROITE;
import static Map.ValueMap.IND_REMOVE;
import static Map.ValueMap.IND_START;
import static Map.ValueMap.MAX_DISTANCE_ABERANT;
import static Map.ValueMap.MAX_DISTANCE_DOUGLAS;
import static Map.ValueMap.MIN_DISTANCE_ABERANT;
import static Map.ValueMap.MIN_DISTANCE_MOYENNE;
import static Map.ValueMap.MIN_DISTANCE_MOYENNE2;
import static Map.ValueMap.MIN_DISTANCE_MOYENNE3;
import static Map.ValueMap.RAYONTERRE;
import static Map.ValueMap.coordonneToString;
import static Map.ValueMap.modeDivisionDistance;
import static Map.ValueMap.modeDivisionDuree;
import static Map.ValueMap.rayonPetitCercle;
...
import importFacture.ShiftImplGPS;
